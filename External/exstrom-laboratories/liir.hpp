...
inline double *binomial_mult( int n, double *p )
{
    int i, j;
    double *a;
...
inline double *trinomial_mult( int n, double *b, double *c )
{
    int i, j;
    double *a;
...
inline double *dcof_bwlp( int n, double fcf )
{
...
inline double *dcof_bwhp( int n, double fcf )
{
...
inline double *dcof_bwbp( int n, double f1f, double f2f )
{
    int k;            // loop variables
...
inline double *dcof_bwbs( int n, double f1f, double f2f )
{
    int k;            // loop variables
    double theta;     // M_PI * (f2f - f1f) / 2.0
    double cp;        // cosine of phi
...
inline double *ccof_bwbs( int n, double f1f, double f2f )
{
    double alpha;
    double *ccof;
    int i, j;
...
inline double sf_bwbp( int n, double f1f, double f2f )
{
    int k;            // loop variables
...
inline double sf_bwbs( int n, double f1f, double f2f )
{
    int k;            // loop variables
